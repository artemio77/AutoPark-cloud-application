...
import {UserManagerRouteAssignComponentComponent} from './application/user-manager-route/user-manager-route-assign-component/user-manager-route-assign-component.component';
...
@NgModule({
  entryComponents: [
    UserSearchComponent,
    UserAssignComponent,
    UserManagerRouteAssignComponentComponent,
